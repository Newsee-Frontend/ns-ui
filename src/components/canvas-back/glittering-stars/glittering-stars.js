...
export const getSvgNode = (node) => {
  let ntg = document.getElementsByTagName('canvas');
...
export const starsBuild = function (node) {
  this.vel = 0.04;
  this.lim = 360;
  this.diff = 200;
  this.initPos = 100;
...
starsBuild.prototype.add = function () {
...
starsBuild.prototype.upd = function () {
  cam.obj.x += (this.toX - cam.obj.x) * 0.05;
  cam.obj.y += (this.toY - cam.obj.y) * 0.05;
};
starsBuild.prototype.draw = function () {
...
starsBuild.prototype.anim = function () {
...
starsBuild.prototype.run = function () {
  this.anim();

  window.addEventListener('mousemove', function (e) {
    this.toX = (e.clientX - this.canvas.width / 2) * 0.6;
    this.toY = (e.clientY - this.canvas.height / 2) * 0.6;
  }.bind(this));
