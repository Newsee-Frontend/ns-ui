function getComConfig(h) {
  return {
    ...
    render(createElement) {
      ...
      const labelNodes = scopeSlotDefault
        ...
        : [
            labelSlot
              ...
              : $createElement('span', { class: 'element-tree-node-label' }, this.node.label),
            this.showLabelLine
              ? $createElement('span', {
      ...
      const lineNodes = [];
      for (let i = 1; i < this.node.level; i++) {
        ...
        lineNodes.push(
          $createElement('span', {
            ...
            style: { left: this.indent * (i - 1) + 14 + 'px' },
          })
        );
      }
          ...
          this.node.level > 1
            ? [
                $createElement('span', {
                  ...
                  style: {
                    width: '10px',
                    left: (this.node.level - 2) * this.indent + 16 + 'px',
                  },
                }),
              ]
            : []
