  ...
  render(h) {
    ...
    const settingColumn = () => {
      return h(`el-table-column`, {
        ...
        scopedSlots: {
          header: scope => {
            return <head-operation setting-state={this.settingState} />;
          },
        },
      });
    };
    ...
    return (
      <div>
        ...
        <actionDrop
          head={this.head}
          headRefer={this.headRefer}
          setting-state={this.settingState}
