<template>
  ...
  >
    ...
    <div slot="footer">
      <div >
        <ns-button type="primary" style="float: left" @click="turnDirection('left')">逆时针旋转</ns-button>
        <ns-button type="primary" style="float: left" @click="turnDirection('right')">顺时针旋转</ns-button>
