    ...
    >
      <div class="first-nav-tit" @click="firstNavClick(firstitem)">
        <div class="oneline-ellipsis">
          <icon-svg :icon-class="firstitem[keyRefer.menuIcon] ? firstitem[keyRefer.menuIcon] : ''"></icon-svg>
      ...
      >
        ...
        <div class="right fl">
          ...
          <div class="second-nav-container" :style="{ 'max-height': second_nav_container_maxheight }">
            <li
              :class="[
              'second-nav-items',
              {
