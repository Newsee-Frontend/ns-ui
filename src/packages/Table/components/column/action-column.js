        ...
        <div class={'action-scope clear'}>
              ...
              <el-dropdown-menu slot="dropdown">
                {list.map((item, index) => [
                  index > 0 ? (
                    <el-dropdown-item
                      key={index}
                      nativeOnClick={this.tableAction.bind(this, item, scope)}
                    >
                      {item.label}
                    </el-dropdown-item>
                  ) : null,
          ...
          list.length === 2 ? (
            <el-button
              class={'fl'}
              type="text"
              on-click={this.tableAction.bind(this, list[1], scope)}
            >
              {list[1].label}
            </el-button>
          ) : null}
              ...
              default: scope => {
                return (
                  <i
                    ...
                    on-click={this.deleteCurrentRow.bind(this, scope.$index, scope.row)}
                  />
                );
              },
            },
