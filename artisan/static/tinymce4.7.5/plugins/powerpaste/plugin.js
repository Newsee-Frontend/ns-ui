  ...
  h('12', Array),
    ...
    g('d', ['2'], function(a) {
      var b = function() {
        ...
        c = function() {
          return a.Env.mac && a.Env.webkit
            ? b() +
                ' <a href="https://support.ephox.com/entries/59328357-Safari-6-1-and-7-Flash-Sandboxing" style="text-decoration: underline">More information on paste for Safari</a>'
            : b();
        },
        d = function() {
        ...
        e = {
          ...
          'cement.dialog.flash.trigger-paste':
            'Your browser requires you to take one more action to paste the images in your content. Please press the below keys to complete the image paste:',
          'cement.dialog.flash.missing':
            'Adobe Flash is required to import images from Microsoft Office. Install the <a href="http://get.adobe.com/flashplayer/" target="_blank">Adobe Flash Player</a>.',
          'cement.dialog.flash.press-escape':
            'Press <span class="ephox-polish-help-kbd">"Close"</span> to paste your content without images.',
          ...
          'flash.crashed':
            'Images have not been imported as Adobe Flash appears to have crashed. This may be caused by pasting large documents.',
    ...
    g('26', ['p', '2d'], function(a, b) {
      var c = b.resolve('upload-image-in-progress'),
        d = 'data-' + b.resolve('image-blob');
    ...
    h('1e', Error),
    g('1f', [], function() {
      return 'undefined' == typeof console && (console = { log: function() {} }), console;
    }),
    ...
    h('1g', document),
    g('k', ['p', '1e', '1f', '1g'], function(a, b, c, d) {
      var e = function(a, b) {
          var e = b || d,
            f = e.createElement('div');
          if (((f.innerHTML = a), !f.hasChildNodes() || f.childNodes.length > 1))
      ...
      var e = function(e, f) {
        var g = function() {
            ...
            if (e.length !== b.length)
              throw 'Wrong number of arguments to struct. Expected "[' +
                e.length +
                ']", got ' +
                b.length +
                ' arguments';
    ...
    g('60', ['1b', 'g'], function(a, b) {
      var c = function(a) {
        ...
        f = function(c, d) {
          ...
          b.each(d, function(b) {
            if (!a.isString(b))
              throw 'The value ' + b + ' in the ' + c + ' fields was not a string.';
          });
        },
        g = function(a, b) {
          throw 'All values need to be of type: ' +
            b +
            '. Keys (' +
            c(a).join(', ') +
            ') were not.';
    ...
    g('3l', ['g', '1c', 'p', 'n', '60', '14'], function(a, b, c, d, e, f) {
      return function(g, h) {
        ...
        return (
          e.validateStrArr('required', g),
          e.validateStrArr('optional', h),
          e.checkDupes(i),
          function(j) {
            var k = b.keys(j),
              l = a.forall(g, function(b) {
    ...
    h('64', isNaN),
    h('65', parseFloat),
    g('3s', ['62', '63', '64', '65'], function(a, b, c, d) {
      var e = function(a) {
          return function(b, c) {
            var d = typeof c;
      ...
      var b = a.contains,
        ...
        f = function(a) {
          var d = [
              ...
              {
                name: 'ChromeFrame',
                versionRegexes: [/.*?chromeframe\/([0-9]+)\.([0-9]+).*/, e],
                search: function(c) {
            ...
            f = [
              ...
              { name: 'Linux', search: c('linux') },
              { name: 'Solaris', search: c('sunos') },
              { name: 'FreeBSD', search: c('freebsd') },
            ];
      ...
      var h = function(a) {
        ...
        i = function(c) {
          for (var i = 0; i < c.undoManager.data.length; i++) {
            var j = c.undoManager.data[i].content,
              k = d.fromTag('div');
        ...
        j = function(a, b, c) {
          for (var d = 0; d < a.undoManager.data.length; d++)
            a.undoManager.data[d].content = a.undoManager.data[d].content
              .split(b.objurl())
              .join(c.location);
        };
    ...
    g('21', ['g', '2c'], function(a, b) {
      return function(c) {
        var d = b.immutable.apply(null, c),
          e = [],
          f = function(a) {
    ...
    g('18', ['g', '2d', '26', '21', '22', 'j', '2a'], function(a, b, c, d, e, f, g) {
      ...
      return function() {
        var b = [],
          c = [],
          g = e.create({ complete: d(['response']) }),
          k = function(a, c) {
        ...
        return (
          b.each(e, function(b, g) {
            ...
            f[i] = function() {
              ...
              if (a !== j.length)
                throw 'Wrong number of arguments to case ' +
                  i +
                  '. Expected ' +
                  j.length +
                  ' (' +
              ...
              return {
                fold: function() {
                  if (arguments.length !== e.length)
                    throw 'Wrong number of arguments to fold. Expected ' +
                      e.length +
                      ', got ' +
                      arguments.length;
                  var a = arguments[g];
    ...
    g('3q', ['g', '27', '3i', '12'], function(a, b, c, d) {
      var e = function(c, d) {
        ...
        j = function(a) {
          for (var b = a.dom().classList, c = new d(b.length), e = 0; e < b.length; e++)
            c[e] = b.item(e);
          return c;
        },
        k = function(a) {
    ...
    g('19', ['g', 'h', 'p', 'n', '2f', '26', '1m', '2c', 'j', '27', '2g', '20', '1f'], function(
      a,
      b,
      c,
      d,
      ...
      var n = h.immutable('image', 'blobInfo'),
        o = g.generate([{ failure: ['error'] }, { success: ['result', 'images', 'blob'] }]),
        p = function(a, b, c) {
          var e = a.isActive(b);
        ...
        r = function(b, d, e, g, h, i, j) {
          ...
          b.upload(i, h, function(b) {
            ...
            a.each(c, k.removeClass(f.uploadInProgress())),
              b.fold(
                function(a) {
                  j(o.failure(a));
                },
    ...
    g('2j', ['1b', 'g', '3r', '2c', '37'], function(a, b, c, d, e) {
      var f = d.immutable('message', 'status', 'contents'),
        g = ['jpg', 'png', 'gif', 'jpeg'],
        h = function(c, d) {
    ...
    g('69', ['1b', '1c', '1l', '73', 'o', '74', 'n', '2f', '37', '1f'], function(
      a,
      b,
      c,
      d,
      ...
      var k = {
        ...
        l = function(l, m, n, o) {
          var p = { url: l, contentType: 'application/json', processData: !1, type: 'GET' },
            q = c.merge(p, o),
            r = f();
          r.open(q.type.toUpperCase(), q.url, !0),
            'blob' === q.responseType && (r.responseType = q.responseType),
            a.isString(q.contentType) && r.setRequestHeader('Content-Type', q.contentType);
          var s = q.dataType,
            t = a.isString(s) && '*' !== s ? k[s] + ', ' + k['*'] + '; q=0.01' : k['*'];
          r.setRequestHeader('Accept', t),
            void 0 !== q.xhrFields &&
              q.xhrFields.withCredentials === !0 &&
              (r.withCredentials = !0),
            a.isObject(q.headers) &&
              b.each(q.headers, function(b, c) {
                a.isString(c) || a.isString(b)
                  ? r.setRequestHeader(c, b)
                  : j.error('Request header data was not a string: ', c, ' -> ', b);
              });
          var u = function(a, b, c) {
              m(a);
            },
            v = function() {
              return 'blob' === q.responseType
                ? g
                    .from(r.response)
                    .map(d)
                    .getOr(e.pure('no response content'))
                : e.pure(r.responseText);
            },
            w = function() {
              v().get(function(a) {
                0 === r.status
                  ? n('Unknown HTTP error (possible cross-domain request)', r.status, a)
                  : n('Could not load url "' + l + '": ' + r.statusText, r.status, a);
              });
            },
            x = function() {
              try {
    ...
    g('75', ['1l'], function(a) {
      var b = {
        ...
        c = function(a, b) {
          for (
            var c = b, d = c.parser[c.strictMode ? 'strict' : 'loose'].exec(a), e = {}, f = 14;
            f--;
    ...
    g('76', ['37'], function(a) {
      var b = function(b) {
        ...
        e = function(d) {
          for (var e = d, f = ''; '' !== e; )
            if (a.startsWith(e, '../')) e = a.removeLeading(e, '../');
            else if (a.startsWith(e, './')) e = a.removeLeading(e, './');
            else if (a.startsWith(e, '/./')) e = '/' + a.removeLeading(e, '/./');
            else if ('/.' === e) e = '/';
            else if (a.startsWith(e, '/../')) (e = '/' + a.removeLeading(e, '/../')), (f = b(f));
            else if ('/..' === e) (e = '/'), (f = b(f));
            else if ('.' === e || '..' === e) e = '';
            else {
              var g = c(e);
        ...
        return (
          '' !== i.protocol
            ? ((j.protocol = i.protocol),
              (j.authority = i.authority),
              (j.path = c.remove(i.path)),
              (j.query = i.query))
            : ('' !== i.authority
                ? ((j.authority = i.authority), (j.path = c.remove(i.path)), (j.query = i.query))
                : ('' === i.path
                    ? ((j.path = h.path),
                      '' !== i.query ? (j.query = i.query) : (j.query = h.query))
                    : (a.startsWith(i.path, '/')
                        ? (j.path = c.remove(i.path))
                        : ((j.path = d.merge(h.path, i.path, e.authority)),
                          (j.path = c.remove(j.path))),
                      (j.query = i.query)),
                  (j.authority = h.authority)),
        ...
        var j = function() {
          ...
          m = function(g, h, j) {
            var k = g.blob(),
              ...
              n = f.getFilename(k, h),
              o = i.credentials !== !0 ? {} : { xhrFields: { withCredentials: !0 } },
              p = b.merge(o, f.buildExtra('image', k, n)),
              q = function(b) {
                var c;
                try {
                  var f = d.parse(b);
                  if (!a.isString(f.location))
                    return void m('JSON response did not contain a string location', 500, b);
                  c = f.location;
                } catch (g) {
                  c = b;
                }
    ...
    h('x', setTimeout),
    g('2l', ['1b', '2f', '2j', '2c', '1f', 'x'], function(a, b, c, d, e, f) {
      ...
      return function(d) {
        var h = function(h, i, j) {
          var k = function(a) {
            ...
            l = function(c) {
              a.isString(c)
                ? j(b.value({ location: c }))
                : (e.error('Image upload result was not a string'), k(''));
            },
            m = c.getFilename(h.blob(), i),
            n = g(i, m, h.blob(), h.data().result);
          f(function() {
            d(n, l, k);
          }, 0);
        };
    ...
    g('b', ['g', 'p', 'n', 'c', '15', '16', '17', '18', '19', '1a', 'j', 'k'], function(
      a,
      b,
      c,
      d,
      ...
      var m = function(d, m) {
        ...
        n = function(a) {
          ...
          return {
            uploadImages: b.noop,
            prepareImages: c.prepareImages,
            getLocalURL: c.getLocalURL,
          };
        };
      return function(a, b) {
        return b ? m(a, b) : n(a);
    ...
    g('3', ['b', 'c'], function(a, b) {
      return function(c) {
        var d =
          !c.uploadImages && c.settings.images_upload_url
            ? {
      ...
      var b =
          ...
          function(b, c, d, e) {
            var f,
              ...
              m = b.getBody();
            if (
              ((j = d.isText()), d.reset(), e.clipboardData && e.clipboardData.getData('text/html'))
            ) {
              e.preventDefault();
              var n = e.clipboardData.getData('text/html'),
                o = n.match(/<html[\s\S]+<\/html>/i),
                p = null === o ? n : o[0];
              return c(p);
            }
            if (!l.get('_mcePaste')) {
              if (
                ...
                return (
                  (h = l.doc.body.createTextRange()),
                  h.moveToElementText(f),
                  h.execCommand('Paste'),
                  l.remove(f),
                  '\ufeff' === f.innerHTML
                    ? (b.execCommand('mcePasteWord'), void e.preventDefault())
                    : (c(j ? f.innerText : f.innerHTML), tinymce.dom.Event.cancel(e))
                );
              var q = function(a) {
                a.preventDefault();
              };
              l.bind(b.getDoc(), 'mousedown', q),
                l.bind(b.getDoc(), 'keydown', q),
                tinymce.isGecko &&
                  ((h = b.selection.getRng(!0)),
                  h.startContainer == h.endContainer &&
                    3 == h.startContainer.nodeType &&
                    ((nodes = l.select('p,h1,h2,h3,h4,h5,h6,pre', f)),
                    1 == nodes.length && l.remove(nodes.reverse(), !0))),
                ...
                window.setTimeout(function() {
                  ...
                  a.each(e, function(b) {
                    ...
                    c &&
                      ...
                      l.remove(c, 1),
                      a.each(l.select('div.mcePaste', b), function(a) {
                        l.remove(a, 1);
                      }),
                    ...
                    g && k.setRng(g),
                    c(d),
                    l.unbind(b.getDoc(), 'mousedown', q),
                    l.unbind(b.getDoc(), 'keydown', q);
                }, 0);
            }
          }),
        c = function(a, c, d) {
        ...
        d = function(a, c, d) {
          return function(e) {
            (tinymce.isOpera || navigator.userAgent.indexOf('Firefox/2') > 0) &&
    ...
    g('1i', [], function() {
      var a = function(a, b) {
        ...
        for (var h = d.createDocumentFragment(); a.firstChild && !g.isBlock(a.firstChild); )
          h.appendChild(a.firstChild);
        for (var i = d.createDocumentFragment(); a.lastChild && !g.isBlock(a.lastChild); )
          i.appendChild(a.lastChild);
        if ((c.parentNode.insertBefore(h, c), g.insertAfter(i, c), a.firstChild)) {
          if (g.isBlock(a.firstChild)) {
            for (; !g.isBlock(c.parentNode) && c.parentNode !== g.getRoot(); )
              c = g.split(c.parentNode, c);
            g.is(c.parentNode, 'td,th') ||
              c.parentNode === g.getRoot() ||
              (c = g.split(c.parentNode, c));
          }
          g.replace(a, c);
        } else g.remove(c);
    ...
    g('1j', ['1h'], function(a) {
      var b = { strip_class_attributes: 'all', retain_style_properties: 'none' },
        c = { strip_class_attributes: 'none', retain_style_properties: 'valid' },
        d = function(a, d) {
        ...
        d = function(d) {
          ...
          f = function() {
            return (
              (e = {}),
              (g = 0),
              a.each(d.attributes, function(a) {
                var c = a.nodeName,
                  d = a.value;
                b(a) && null !== d && void 0 !== d && ((e[c] = d), g++);
              }),
              void 0 === e.style && d.style.cssText && ((e.style = d.style.cssText), g++),
              (f = h),
              e
            );
          };
                ...
                (f = function() {
                  return (
                    ...
                    o(function(a, b) {
                      var c = j(a, b);
                      null === c
                        ? (d.removeAttribute(a), delete e[a], g--)
                        : c !== b &&
                          ('class' === a ? (d.className = c) : d.setAttribute(a, c), (e[a] = c));
                    }),
                    (f = h),
                    e
                  );
    ...
    g('3w', ['6c', '1h'], function(a, b, c) {
      var d = 'startElement',
        ...
        l = function(a, c, d) {
          var e, f, g;
          a.style.length;
          (g = c || a.getAttribute('style')),
            (void 0 !== g && null !== g && g.split) || (g = a.style.cssText),
            b.each(g.split(';'), function(a) {
              var c = a.indexOf(':');
              c > 0 &&
                ((e = b.trim(a.substring(0, c))),
                e.toUpperCase() === e && (e = e.toLowerCase()),
                (e = j(e)),
                (f = b.trim(a.substring(c + 1))),
                k || (k = 0 === e.indexOf('mso-')),
                d(e, f));
            }),
          ...
          switch (a.nodeType) {
            case 1:
              c
                ...
                (m =
                  'HTML' !== a.scopeName && a.scopeName && a.tagName && a.tagName.indexOf(':') <= 0
                    ? (a.scopeName + ':' + a.tagName).toUpperCase()
                    : a.tagName);
              break;
            case 3:
              (k = f), (n = a.nodeValue);
                ...
                b.each(p, function(b, d) {
                  ...
                  null === f
                    ? (a.style.removeProperty
                        ? a.style.removeProperty(i(d))
                        : a.style.removeAttribute(i(d)),
                      delete p[d])
                    : ((e += d + ': ' + f + '; '), (p[d] = f));
                }),
                  (e = e ? e : null),
    ...
    g('2n', ['3w'], function(a) {
      var b = function(b, c) {
        ...
        (c = c || window.document),
          ...
          (d.innerHTML = b),
          (nextNode = d.firstChild || a.FINISHED);
        var e = [];
        endNode = !1;
        var f = function(b, c) {
          ...
          g = function() {
            var b = nextNode,
              g = endNode;
            return (
              !endNode && nextNode.firstChild
                ? (e.push(nextNode), (nextNode = nextNode.firstChild))
                : endNode || 1 !== nextNode.nodeType
                ? nextNode.nextSibling
                  ? ((nextNode = nextNode.nextSibling), (endNode = !1))
                  : ((nextNode = e.pop()), (endNode = !0))
                : (endNode = !0),
              b === a.FINISHED || nextNode || (c.body.removeChild(d), (nextNode = a.FINISHED)),
              f(b, g)
            );
          },
          h = function() {
      ...
      return a.createFilter(function(a, c) {
        ...
        switch (c.type()) {
          ...
          case b.END_ELEMENT_TYPE:
            f && (d(c) || c === b.FINISHED)
              ? (a.emit(b.createEndElement('P', a.document)), (f = !1))
              : 'BR' === c.tag() && a.emit(c);
            break;
          case b.START_ELEMENT_TYPE:
            'BR' === c.tag()
              ? (c.filterAttributes(e), c.filterStyles(e), a.emit(c))
              : 'IMG' === c.tag() &&
                c.getAttribute('alt') &&
                (g(), a.emit(b.createText(c.getAttribute('alt'), a.document)));
        }
    ...
    g('3y', ['3w'], function(a) {
      var b = function() {
        ...
        f = function(b, c) {
          return b.type() === a.START_ELEMENT_TYPE
            ? 0 === b.getAttributeCount() ||
                (c &&
                  1 === b.getAttributeCount() &&
                  null !== b.getAttribute('style') &&
                  void 0 !== b.getAttribute('style'))
            : b.type() === a.END_ELEMENT_TYPE;
        };
      ...
      var c = [
        ...
        g = function(a, g, i) {
          var j,
            ...
            m = null;
          return (
            a && ((j = a.text), (k = a.symbolFont)),
            (j = b.trim(j)),
            (m = e[j]),
            m
              ? (m = f(m, j))
              : k
              ? ((m = d[j]), (m = m ? f(m, j) : { tag: 'UL', variant: j }))
              : (b.each(c, function(a) {
                  if (a.regex.test(j)) {
                ...
                m &&
                  !m.variant &&
                  ((l = '(' === j.charAt(0) ? '()' : ')' === j.charAt(j.length - 1) ? ')' : '.'),
                  (m = f(m, l)))),
            m &&
              'OL' === m.tag &&
              i &&
              ('P' !== i.tag() || /^MsoHeading/.test(i.getAttribute('class'))) &&
              (m = null),
            m
          );
        },
        h = function(a, b, c) {
          return (
            a === b ||
            (a && b && a.tag === b.tag && a.type === b.type && (c || a.variant === b.variant))
          );
        },
        i = function(b, c) {
          return (
            b.type() == a.START_ELEMENT_TYPE &&
              ((font = b.getStyle('font-family')),
              font
                ? (c = 'Wingdings' === font || 'Symbol' === font)
                : /^(P|H[1-6]|DIV)$/.test(b.tag()) && (c = !1)),
            c
          );
        };
    ...
    g('3z', ['3w', '42', '1h'], function(a, b, c) {
      var d = function(d, e) {
          ...
          if (d.type() === a.START_ELEMENT_TYPE && e.openedTag && 'SPAN' === d.tag()) {
            for (
              f = e.openedTag.getNode(),
                j(f),
                f.childNodes.length > 1 &&
                  'A' === f.firstChild.tagName &&
                  '' === f.firstChild.textContent &&
                  (f = f.childNodes[1]);
              f.firstChild && ('SPAN' === f.firstChild.tagName || 'A' === f.firstChild.tagName);
            ...
            if (
              ((g = f.value),
              c.trim(g) || ((f = f.parentNode.nextSibling), (g = f ? f.value : '')),
              !f || c.trim(f.parentNode.textContent) != g)
            )
              return !1;
            if ((h = b.guessListType({ text: g, symbolFont: i }, null, e.originalToken)))
              return (
                f.nextSibling &&
                'SPAN' === f.nextSibling.tagName &&
                /^[\u00A0\s]/.test(f.nextSibling.firstChild.value) &&
                ('P' === e.openedTag.tag() || 'UL' === h.tag)
              );
          }
          return !1;
        },
        e = function(a, b) {
          var c,
            d = 0;
          for (c = a.parentNode; null !== c && void 0 !== c && c !== b.parentNode; )
            (d += c.offsetLeft), (c = c.offsetParent);
          return d;
        },
        f = function(a) {
          var b = {};
        ...
        h = f(function(a, b) {
          var d,
            ...
            h,
            i = /([^{]+){([^}]+)}/g;
          for (i.lastIndex = 0; null !== (d = i.exec(a)) && !e; )
            c.each(d[1].split(','), g(selector));
          return (
            !!e &&
            ((f = document.createElement('p')),
            f.setAttribute('style', e),
            (h = c.ephoxGetComputedStyle(f)),
            !!h && '' + h.marginLeft)
          );
        }),
        i = function() {
          var a,
            ...
            c = function(c, d, f, g) {
              var i,
                j,
                k = 1;
              return g && /^([0-9]+\.)+[0-9]+\.?$/.test(g.text)
                ? g.text.replace(/([0-9]+|\.$)/g, '').length + 1
                : ((i = b || parseInt(h(f, d.getAttribute('class')))),
                  (j = e(c.getNode(), d.getNode())),
                  i ? (a ? (j += a) : 0 === j && ((a = i), (j += i))) : (i = 48),
                  (b = i = Math.min(j, i)),
                  (k = Math.max(1, Math.floor(j / i)) || 1));
            };
        ...
        j = function() {
          var b = !1,
            c = '',
            d = function(d) {
              return b && d.type() === a.TEXT_TYPE
                ? ((c += d.text()), !0)
                : d.type() === a.START_ELEMENT_TYPE && 'STYLE' === d.tag()
                ? ((b = !0), !0)
                : d.type() === a.END_ELEMENT_TYPE && 'STYLE' === d.tag() && ((b = !1), !0);
            };
          return { check: d };
        };
        ...
        var f,
          ...
          j = function(b, d) {
            var h = {},
              j = {};
            i++,
              d && b.type && (h = { 'list-style-type': b.type }),
              b.start && b.start > 1 && (j = { start: b.start }),
              g.push(b),
              c.emit(a.createStartElement(b.tag, j, h, e)),
              (f = b);
          },
          k = function() {
          ...
          n = function(d, g, i) {
            ...
            f &&
              ...
              (k(),
              i &&
                (c.emit(a.createStartElement('P', {}, {}, e)),
                c.emit(a.createText('\xa0', e)),
                c.emit(a.createEndElement('P', e))),
              j(g, !0)),
              c.emit(a.createStartElement('LI', {}, l, e)),
              d && 'P' != d.tag()
                ? (h.push(d.tag()),
                  d.filterStyles(function() {
                    return null;
                  }),
                  c.emit(d))
                : h.push('P');
          ...
          o = function(b, f, g, l) {
            if (g) {
              for (i || (i = 0); i > b; ) m(), k();
              if (((g = d(g, b)), i == b)) m(), n(f, g, l);
              else
                for (
                  b > 1 &&
                  h.length > 0 &&
                  'P' !== h[h.length - 1] &&
                  (c.emit(a.createEndElement(h[h.length - 1], e)), (h[h.length - 1] = 'P'));
                  i < b;

                )
                  j(g, i == b - 1), n(i == b ? f : void 0, g);
            }
          },
          p = function() {
            return i;
    ...
    g('41', ['3y', '3w', '3z', '42', '1h'], function(a, b, c, d, e) {
      var f = function(a, b) {
        ...
        h = function(c, d, f) {
          f.type() === b.TEXT_TYPE && '' === e.trim(f.text())
            ? c.defer(f)
            : d.skippedPara ||
              ...
              a.hasMsoListStyle(f)
            ? j(c, d, f)
            : ((d.openedTag = f), c.defer(f), (d.nextFilter = i));
        },
        i = function(d, e, f) {
          f.type() !== b.START_ELEMENT_TYPE ||
          'SPAN' !== f.tag() ||
          0 !== e.spanCount.length ||
          (!a.supportsCustomStyles && c.isListWithoutCommentsOrStyles(f, e)) ||
          a.hasMsoListStyle(f)
            ? f.type() === b.END_ELEMENT_TYPE
              ? 'SPAN' === f.tag()
                ? (d.defer(f), e.spanCount.pop())
                : 'P' === f.tag()
                ? (d.defer(f), (e.skippedPara = !0), (e.openedTag = null), (e.nextFilter = h))
                : ((e.nextFilter = j), e.nextFilter(d, e, f))
              : f.isWhitespace()
              ? d.defer(f)
              : ((e.nextFilter = j), e.nextFilter(d, e, f))
            : (d.defer(f), e.spanCount.push(f));
        },
        j = function(d, e, f) {
          var g = function() {
          ...
          if (f.type() === b.START_ELEMENT_TYPE && a.hasMsoListStyle(f) && 'LI' !== f.tag()) {
            ...
            h && h[1]
              ? ((e.itemLevel = parseInt(h[1], 10) + e.styleLevelAdjust),
                e.nextFilter === j ? d.emitDeferred() : d.dropDeferred(),
                (e.nextFilter = l),
                d.startTransaction(),
                (e.originalToken = f),
                (e.commentMode = !1))
            ...
            !a.supportsCustomStyles &&
            ((f.type() === b.COMMENT_TYPE && '[if !supportLists]' === f.text()) ||
              c.isListWithoutCommentsOrStyles(f, d))
              ? (f.type() === b.START_ELEMENT_TYPE && 'SPAN' === f.tag() && e.spanCount.push(f),
                (e.nextFilter = l),
                d.startTransaction(),
                ...
                (e.openedTag = null),
                d.dropDeferred())
              : f.type() === b.END_ELEMENT_TYPE && a.spanOrA(f)
              ? (d.defer(f), e.spanCount.pop())
              : f.type() === b.START_ELEMENT_TYPE
              ? a.spanOrA(f)
                ? (d.defer(f), e.spanCount.push(f))
                : (e.openedTag && (e.emitter.closeAllLists(), d.emitDeferred()),
                  (e.openedTag = f),
                  d.defer(f))
              : g();
        },
        k = function(a, c, d) {
          d.type() === b.END_ELEMENT_TYPE &&
            c.originalToken.tag() === d.tag() &&
            ((c.nextFilter = h), (c.styleLevelAdjust = -1)),
            a.emit(d);
        },
        l = function(a, c, d) {
          if (
            (d.type() == b.START_ELEMENT_TYPE &&
              'Ignore' === d.getStyle('mso-list') &&
              (c.nextFilter = m),
            d.type() === b.START_ELEMENT_TYPE && 'SPAN' === d.tag())
          )
            c.spanCount.push(d),
              ((c.commentMode && '' === d.getAttribute('style')) ||
                null === d.getAttribute('style')) &&
                (c.nextFilter = m);
          else if ('A' === d.tag())
            d.type() === b.START_ELEMENT_TYPE ? c.spanCount.push(d) : c.spanCount.pop();
          else if (d.type() === b.TEXT_TYPE)
            if (c.commentMode) (c.nextFilter = m), c.nextFilter(a, c, d);
            else {
              var g = c.originalToken,
                h = c.spanCount;
              c.emitter.closeAllLists(),
                a.emit(g),
                e.each(h, e.bind(a.emit, a)),
                a.emit(d),
                a.commit(),
                (c.originalToken = g),
                (c.nextFilter = k);
        ...
        m = function(c, d, e) {
          e.type() === b.TEXT_TYPE
            ? e.isWhitespace() ||
              ((d.nextFilter = n), (d.bulletInfo = { text: e.text(), symbolFont: d.symbolFont }))
            : a.spanOrA(e)
            ? e.type() === b.START_ELEMENT_TYPE
              ? d.spanCount.push(e)
              : d.spanCount.pop()
            : e.type() === b.START_ELEMENT_TYPE && 'IMG' === e.tag()
            ? ((d.nextFilter = n), (d.bulletInfo = { text: '\u2202', symbolFont: !0 }))
            : f(c, e);
        },
        n = function(c, d, e) {
          e.type() === b.START_ELEMENT_TYPE && a.spanOrA(e)
            ? (d.spanCount.push(e), (d.nextFilter = o))
            : e.type() === b.END_ELEMENT_TYPE && a.spanOrA(e)
            ? (d.spanCount.pop(), (d.nextFilter = p))
            : (e.type() === b.END_ELEMENT_TYPE && 'IMG' === e.tag()) || f(c, e);
        },
        o = function(c, d, e) {
          e.type() === b.END_ELEMENT_TYPE &&
            (a.spanOrA(e) && d.spanCount.pop(), (d.nextFilter = p));
        },
        p = function(c, h, i) {
          var j = function(a) {
            if (
              ((h.nextFilter = q),
              h.commentMode &&
                (h.itemLevel = h.indentGuesser.guessIndentLevel(
                  i,
                  h.originalToken,
                  h.styles.styles,
                  h.bulletInfo
                )),
              (h.listType = d.guessListType(
                h.bulletInfo,
                g(h.emitter.getCurrentListType(), h.emitter.getCurrentLevel(), h.itemLevel),
                h.originalToken
              )),
              h.listType)
            ) {
              for (
                h.emitter.openItem(h.itemLevel, h.originalToken, h.listType, h.skippedPara),
                  c.emitDeferred();
                h.spanCount.length > 0;

              )
                c.emit(h.spanCount.shift());
              a && c.emit(i);
            } else
              e.log(
                'Unknown list type: ' +
                  h.bulletInfo.text +
                  ' Symbol font? ' +
                  h.bulletInfo.symbolFont
              ),
                c.rollback();
          };
          i.type() === b.TEXT_TYPE || i.type() === b.START_ELEMENT_TYPE
            ? j(!0)
            : i.type() === b.COMMENT_TYPE
            ? j('[endif]' !== i.text())
            : i.type() === b.END_ELEMENT_TYPE
            ? a.spanOrA(i) && h.spanCount.pop()
            : f(c, i);
        },
        q = function(a, c, d) {
          d.type() === b.END_ELEMENT_TYPE && d.tag() === c.originalToken.tag()
            ? ((c.nextFilter = h), (c.skippedPara = !1))
            : a.emit(d);
        },
        r = j;
      return { initial: r };
    ...
    g('2p', ['3x', '3y', '3w', '3z', '40', '41', '42', '1h'], function(a, b, c, d, e, f, g, h) {
      var i = {},
        j = function(a) {
          (i.nextFilter = f.initial),
            (i.itemLevel = 0),
            (i.originalToken = null),
            (i.commentMode = !1),
            (i.openedTag = null),
            (i.symbolFont = !1),
            (i.listType = null),
            (i.indentGuesser = d.indentGuesser()),
            (i.emitter = e(a, a.document)),
            (i.styles = d.styles()),
            (i.spanCount = []),
            (i.skippedPara = !1),
            (i.styleLevelAdjust = 0),
            (i.bulletInfo = void 0);
        };
      j({});
      var k = function(a) {
        ...
        l = function(a, b) {
          i.styles.check(b) ||
            ((i.symbolFont = g.checkFont(b, i.symbolFont)), i.nextFilter(a, i, b));
        };
    ...
    g('2q', ['1h'], function(a) {
      var b = function(a) {
          var b = a,
            c = 65279 === b.charCodeAt(b.length - 1);
        ...
        g = [b],
        h = tinymce.isIE && document.documentMode >= 9 ? [f, e, d, c].concat(g) : g,
        i = a.compose(h);
    ...
    g('44', ['3x', '3w'], function(a, b) {
      return a.createFilter(function(a, c) {
        a.seenList
          ...
          : a.inferring
          ? ('LI' === c.tag() &&
              (c.type() === b.START_ELEMENT_TYPE
                ? a.inferring++
                : (a.inferring--, a.inferring || (a.needsClosing = !0))),
            a.emit(c))
          : ('OL' === c.tag() || 'UL' === c.tag()
              ? (a.seenList = !0)
              : 'LI' === c.tag() &&
                ((a.inferring = 1),
                a.needsClosing || a.emit(b.createStartElement('UL', {}, {}, a.document))),
            !a.needsClosing ||
              a.inferring ||
              c.isWhitespace() ||
              ((a.needsClosing = !1), a.emit(b.createEndElement('UL', a.document))),
            a.emit(c));
      });
    }),
    g('45', ['3x'], function(a) {
    ...
    g('46', ['3x'], function(a) {
      return a.createAttributeFilter(function(a, b) {
        var c;
        if ('class' === a)
          switch ((c = this.settings.get('strip_class_attributes'))) {
            case 'mso':
      ...
      var d = [],
        ...
        g = function(a, b) {
          var e,
            ...
            g = 1;
          for (e = b + 1; e < a; e++)
            if (((f = d[e]), f && 'SPAN' === f.tag()))
              if (f.type() === c.START_ELEMENT_TYPE) g++;
              else if (f.type() === c.END_ELEMENT_TYPE && (g--, 0 === g)) return void (d[e] = null);
        },
        h = function(a) {
          if (f) {
            var h,
            ...
            for (i = 0; i < j; i++)
              (h = d[i]),
                h &&
                  (h.type() === c.START_ELEMENT_TYPE && 'SPAN' === h.tag() && b.hasNoAttributes(h)
                    ? g(j, i)
                    : a.emit(h));
          }
          (d = []), (e = []), (f = !1);
        ...
        i = function(a, b) {
          if ((d.push(b), (e = e || []), b.type() === c.START_ELEMENT_TYPE)) e.push(b);
          else if (b.type() === c.END_ELEMENT_TYPE && (e.pop(), 0 === e.length))
            return void h(a, b);
        };
      return a.createFilter(function(a, e) {
        var g =
          ',FONT,EM,STRONG,SAMP,ACRONYM,CITE,CODE,DFN,KBD,TT,B,I,U,S,SUB,SUP,INS,DEL,VAR,SPAN,';
        d = d || [];
        var h = function(a) {
          return !(g.indexOf(',' + a.tag() + ',') >= 0 && b.hasNoAttributes(a, !0));
        };
        0 === d.length
          ? e.type() === c.START_ELEMENT_TYPE
            ? h(e)
              ? a.emit(e)
              : i(a, e)
            : a.emit(e)
      ...
      return a.createFilter(function(a, c) {
        if ('IMG' === c.tag()) {
          ...
          if (c.type() === b.START_ELEMENT_TYPE) {
            ...
            if (
              a.settings.get('base_64_images') &&
              /^data:image\/.*;base64/.test(c.getAttribute('src'))
            )
              return void (a.skipEnd = !0);
          }
        }
        a.emit(c);
      });
    ...
    g('4c', ['3x', '3y', '3w'], function(a, b, c) {
      ...
      return a.createFilter(function(a, b) {
        var f;
        b.type() === c.START_ELEMENT_TYPE && 'A' === b.tag()
          ? (e.push(b), d(b) && a.defer(b))
          : b.type() === c.END_ELEMENT_TYPE && 'A' === b.tag()
          ? ((f = e.pop()), d(f) && a.defer(b), 0 === e.length && a.emitDeferred())
          : a.hasDeferred()
          ? a.defer(b)
          : a.emit(b);
      });
    ...
    g('4d', ['3x', '3w'], function(a, b) {
      ...
      return a.createFilter(function(a, d) {
        'SCRIPT' === d.tag()
          ? (c = d.type() === b.START_ELEMENT_TYPE)
          : c ||
            (d.filterAttributes(function(a, b) {
              return /^on/.test(a) || 'language' === a ? null : b;
            }),
            a.emit(d));
      });
    }),
    g('2r', ['43', '44', '45', '46', '47', '48', '49', '4a', '4b', '4c', '4d'], function(
      a,
      b,
      c,
      d,
    ...
    g('1k', ['2m', '2n', '2o', '2p', '2q', '2r', '2s'], function(a, b, c, d, e, f, g) {
      var h = function(a, b, c, d) {
        ...
        l = function(a) {
          return (
            a.indexOf('<o:p>') >= 0 ||
            a.indexOf('p.MsoNormal, li.MsoNormal, div.MsoNormal') >= 0 ||
            a.indexOf('MsoListParagraphCxSpFirst') >= 0 ||
            a.indexOf('<w:WordDocument>') >= 0
          );
        };
      ...
      return function(e, f) {
        var g = function(g) {
          var h = function(d) {
              ...
              var h = b.create(
                  d || e.settings.powerpaste_word_import,
                  d || e.settings.powerpaste_html_import,
                  !0
                ),
                i = c.filter(f.content, h, e.getDoc());
              e.fire('PastePostProcess', i),
            ...
            j = function() {
              var a,
                ...
                g = [
                  { text: f('cement.dialog.paste.clean'), onclick: b },
                  { text: f('cement.dialog.paste.merge'), onclick: c },
                ],
                i = {
              ...
              (a = e.windowManager.open(i)),
                d(function() {
                  a && a.getEl().focus();
                }, 1);
            };
          c.isWordContent(g) && !i(e.settings.powerpaste_word_import)
            ? j()
            : i(e.settings.powerpaste_html_import)
            ? h()
            : j();
        };
        return { showDialog: g };
    ...
    g('4', ['d', 'e', 'f'], function(a, b, c) {
      return function(d, e, f) {
        ...
        (g = b.getOnPasteFunction(d, j.showDialog, e)),
          d.on('paste', k(g)),
          (h = b.getOnKeyDownFunction(d, j.showDialog, e)),
          d.on('keydown', k(h)),
          d.addCommand('mceInsertClipboardContent', function(a, b) {
            j.showDialog(b.content || b);
          }),
          d.settings.paste_preprocess &&
            d.on('PastePreProcess', function(a) {
    ...
    g('1n', ['g', '1s', '2t', 'h', 'o', '2u', '2b', 'j'], function(a, b, c, d, e, f, g, h) {
      var i = c.detect(),
        ...
        r = function() {
          return i.browser.isChrome() || i.browser.isSafari() || i.browser.isOpera()
            ? p
            : i.browser.isFirefox()
            ? o
            : i.browser.isIE()
        ...
        var o = function(a) {
          ...
          t = function(c) {
            return a
              .map(c, function(a) {
                var c = e.fromTag('img'),
                  f = b.cata(a, l.getLocalURL, function(a, b, c) {
                    return b;
                  });
          ...
          u = function(a) {
            c.multiple(a).get(function(a) {
              var b = t(a);
              i.insertContent(b, { merge: i.settings.paste_merge_formats !== !1 }),
                l.uploadImages(a);
            });
          };
    ...
    g('2w', ['n', '1m'], function(a, b) {
      var c = b.generate([
          ...
          { cancel: [] },
          { incomplete: ['elements', 'assets', 'correlated', 'message'] },
        ]),
    ...
    g('4q', ['4r', '2w', '1v', '2c'], function(a, b, c, d) {
      var e = d.immutableBag(['response', 'bundle'], []),
        f = function(a) {
          return l(function(b) {
            var c = e(a);
            b(c);
    ...
    g('2v', ['4q', '4r', '2w', 'g', 'p', '23', '2c'], function(a, b, c, d, e, f, g) {
      var h = g.immutable('steps', 'input', 'label', 'capture'),
        ...
        k = function(d, f) {
          var g = e.curry(a.pass, d),
            h = function() {
              return f().map(function(e) {
                var f = b.merge(d.bundle(), e.bundle()),
                  g = c.carry(d.response(), e.response());
    ...
    g('2y', ['2t', 'p', 'x'], function(a, b, c) {
      var d = a.detect(),
        ...
        g = d.browser.isIE() && d.browser.version.major <= 10,
        h = g ? e : f,
        i = function(a, b, c) {
          return h(a, b, c);
        };
    ...
    g('1o', ['2v', '2w', 'g', 'p', '2x', '21', '22', '2y'], function(a, b, c, d, e, f, g, h) {
      return function(i, j) {
        var k = g.create({
            cancel: f([]),
            error: f(['message']),
            insert: f(['elements', 'assets', 'correlated']),
          }),
          l = e.tap(function(d) {
    ...
    g('4u', ['68', 'i', 'o', '2b', 'n'], function(a, b, c, d, e) {
      var f = function(a) {
          return void 0 !== a.convertURL
            ? a.convertURL
            : void 0 !== a.msConvertURL
            ? a.msConvertURL
            : void 0;
        },
        g = function(g) {
          var h = a.resolve('window.clipboardData.files'),
            i = f(g);
    ...
    g('4x', ['1l', '1m'], function(a, b) {
      var c = b.generate([{ none: [] }, { error: ['message '] }, { blob: ['blob'] }]),
        d = function(a, b, c, d) {
          return a.fold(b, c, d);
        };
      return a.merge(c, { cata: d });
    ...
    g('6d', ['4x', '78', '79', '7a', 'n', '2f', '37', '12', '62'], function(
      a,
      b,
      c,
      d,
      ...
      var j = function(a, e) {
          for (
            var f = 1024, g = d.atob(a), j = g.length, k = i.ceil(j / f), l = new h(k), m = 0;
            m < k;
            ++m
          ) {
            for (
              var n = m * f, o = i.min(n + f, j), p = new h(o - n), q = n, r = 0;
              q < o;
              ++r, ++q
            )
              p[r] = g[q].charCodeAt(0);
            l[m] = c(p);
          }
          return b(l, { type: e });
        },
        ...
        l = function(b) {
          ...
          var c = b.indexOf(';'),
            d = b.substr('data:'.length, c - 'data:'.length),
    ...
    g('4y', ['2w', 'g', 'h', 'p', '2c', 'j', 'k', '1d', '2a', '1f'], function(
      a,
      b,
      c,
      d,
    ...
    g(
      '32',
      ['4w', '4x', '4q', '4y', '2w', 'g', 'i', 'n', '2c', 'j', 'k', '1d', '1y', '29', '2a'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
        var p = i.immutable('blob', 'image'),
          q = function(c, d) {
            var e = a.toBlob(d);
            ...
            return c.sync(function(b) {
              var i = function() {
                ...
                k = function(a) {
                  ...
                  f.each(d, m.remove),
                    c.call(b, { response: d.length > 0 ? x(a) : h.response(), bundle: h.bundle() });
                },
                l = function(b, c, d, e) {
    ...
    g('50', ['5c', '1l', 'p', 'n', '27', 'k', '28', '1x', '29'], function(
      a,
      b,
      c,
      d,
      ...
      return function(j, k) {
        var l = k.translations,
          ...
          n = function(b, c) {
            ...
            var p = f.fromTag('p'),
              q = g.fromHtml(l('cement.dialog.paste.instructions'));
            ...
            var r = {
              ...
              v = j(!0);
            v.setTitle(l('cement.dialog.paste.title')),
              v.setContent(o),
              v.setButtons([r, s]),
              v.show(),
              v.events.close.bind(u);
          },
          o = function(a, b) {
            var c = a ? 'officeStyles' : 'htmlStyles',
              d = k[c];
      ...
      var f = function(f, g) {
              ...
              h.get(c.isWord(g), function(c) {
                var g = c.fold(
                  ...
                  function(a) {
                    return {
                      response: i,
                      bundle: b.nu({ officeStyles: a.officeStyles, htmlStyles: a.htmlStyles }),
                    };
                  }
                );
                a.call(d, g);
        ...
        h = function(c, d) {
          return function(e, f) {
            return a.pure({
              response: f.response(),
              bundle: b.nu({ officeStyles: c, htmlStyles: d }),
            });
          };
        };
    ...
    g('7r', ['2t', 'p', 'k', '1g'], function(a, b, c, d) {
      var e = function(a) {
        ...
        g = a.detect().browser,
        h = g.isIE() || g.isSpartan() ? f : e,
        i = b.constant(b.constant(!0)),
        j = function(a, b) {
    ...
    h('11', window),
    g('5d', ['1b', 'g', '1c', 'n', 'j', '5i', 'k', '1d', '6q', '37', '1e', '1f', '11'], function(
      a,
      b,
      c,
      d,
    ...
    g('5a', ['n', 'j', '27', '5d', 'k', '1d', '6r', '6s', '2a', '37'], function(
      a,
      b,
      c,
      d,
      ...
      var k = function(a, b) {
          var c = f.value(a),
            ...
            h = c.indexOf(']>');
          return (
            (d.dom().innerHTML = c.substr(h + ']>'.length)),
            g.descendant(d, function(a) {
              return f.name(a) === b;
            })
          );
        },
        ...
        m = function(a) {
          return l(a).map(function(a) {
            var f = b.get(a, 'o:spid'),
              g = void 0 === f ? b.get(a, 'id') : f,
              h = e.fromTag('img');
            return (
              c.add(h, 'rtf-data-image'),
              b.set(h, 'data-image-id', g.substr('_x0000_'.length)),
              b.set(h, 'data-image-type', 'code'),
              d.setAll(h, { width: d.get(a, 'width'), height: d.get(a, 'height') }),
              h
            );
          });
        },
          ...
          if ('img' === f.name(d)) {
            ...
            if (void 0 !== e && null !== e && j.startsWith(e, 'file://')) {
              var g = h.shallow(d),
                ...
                k = i[i.length - 1];
              return (
                b.set(g, 'data-image-id', k),
                b.remove(g, 'src'),
                b.set(g, 'data-image-type', 'local'),
    ...
    g('6e', ['7b', 'g', '5a', 'n', '23', '2c', 'j', '28', '2a', '1f'], function(
      a,
      b,
      c,
      d,
      ...
      var k = f.immutable('img', 'vshape'),
        ...
        o = function(d) {
          var f = h.fromHtml(d),
            g = b.bind(f, function(a) {
              return i.descendants(a, 'img');
            }),
            j = b.bind(f, a.find),
            k = e.cat(b.map(j, c.scour)),
            l = b.map(g, function(a) {
              return p(a, k);
            });
          return e.cat(l);
        },
        p = function(a, c) {
          var e = g.get(a, 'v:shapes'),
            f = d.from(
              b.find(c, function(a) {
                return g.get(a, 'id') === e;
              })
          ...
          return (
            f.isNone() && j.log('WARNING: unable to find data for image', a.dom()),
            f.map(function(b) {
              return q(a, b);
            })
          );
    ...
    g('7c', ['1b', 'g', 'p', 'n', 'j', '27'], function(a, b, c, d, e, f) {
      var g = function(b, c) {
          ...
          if (e.has(b, 'width') && e.has(b, 'height') && a.isString(d)) {
            ...
            null === f ||
              ('90' !== f[1] && '-90' !== f[1]) ||
              e.setAll(b, { width: e.get(b, 'height'), height: e.get(b, 'width') });
          }
        },
        h = function(a, b) {
          var c = b['o:spid'],
            d = void 0 === c ? b.id : c;
          g(a, b),
            f.add(a, 'rtf-data-image'),
            e.set(a, 'data-image-id', d.substr('_x0000_'.length)),
            e.set(a, 'data-image-type', 'code');
        },
        i = function(a, b, c) {
          return c.img()[a] === b;
        },
    ...
    g('7e', ['j', 'k', '1x', '20', '7t', '7u', '12'], function(a, b, c, d, e, f, g) {
      var h = function(c) {
        ...
        j = function(a, b, e) {
          var g = h(e),
            j = void 0 === b ? a : f.replaceMany(a, b);
          i(g, j, e);
      ...
      a('7g', [], function() {
          ...
          return (
            (a = function(a) {
              var c,
                ...
                f,
                g = [];
              for (c = a.split(','), e = 0, f = c.length; e < f; e += 1)
                (d = c[e]), d.length > 0 && g.push(b(d));
              return g;
            }),
            (b = function(a) {
              var b,
              ...
              return (
                (b = function(b, f) {
                  var g, h, i, j, k, l;
                  if (b.test(c))
                    for (g = c.match(b), h = 0, i = g.length; h < i; h += 1)
                      (d[f] += 1),
                        (j = g[h]),
                        (k = c.indexOf(j)),
                        (l = j.length),
                        e.push({ selector: a.substr(k, l), type: f, index: k, length: l }),
                ...
                (function() {
                  var a = function(a) {
                      var b, d, e, f;
                      if (a.test(c))
                        for (b = c.match(a), d = 0, e = b.length; d < e; d += 1)
                          (f = b[d]), (c = c.replace(f, Array(f.length + 1).join('A')));
                    },
                    b = /\\[0-9A-Fa-f]{6}\s?/g,
                    d = /\\[0-9A-Fa-f]{1,5}\s/g,
                    e = /\\./g;
                ...
                (function() {
                  var a,
                    ...
                    f = new RegExp('{[^]*', 'gm');
                  if (f.test(c))
                    for (a = c.match(f), b = 0, d = a.length; b < d; b += 1)
                      (e = a[b]), (c = c.replace(e, Array(e.length + 1).join(' ')));
                })(),
                b(f, 'b'),
                b(g, 'a'),
                b(h, 'b'),
        ...
        return (
          'undefined' != typeof exports &&
            ((exports.calculate = a.calculate), (exports.compare = a.compare)),
          a
        );
      });
    })(f.bolt.module.api.define, f.bolt.module.api.require, f.bolt.module.api.demand),
    g('6f', ['7c', 'g', 'p', '2c', 'j', '7d', '5d', '1y', '2a', '3f', '7e', '7f', '7g'], function(
      a,
      b,
      c,
      d,
      ...
      var n = d.immutable('selector', 'raw'),
        ...
        s = function(a, c) {
          var d = k.stylesheets(a),
            ...
            i = b.flatten(b.map(b.filter(e, f), h)),
            j = b.filter(e, g),
            o = j.concat(i);
          o
            .sort(function(a, b) {
    ...
    g('71', ['n', 'k'], function(a, b) {
      var c = function(c) {
          ...
          try {
            ...
            return (
              console.log('Error reading iframe: ', d), console.log('Error was: ' + f), a.none()
            );
          }
        },
        d = function(a) {
          ...
          return function(f) {
            if (d(f)) {
              var g = b.fromDom(f.target),
                ...
                k = c(g, f.clientX, f.clientY, h, i, j, f);
              e(k);
            }
          };
        },
    ...
    g('6h', ['k', '28', '1x', '29', '1y', '3f'], function(a, b, c, d, e, f) {
      var g = function(a) {
        ...
        h = function(g, h) {
          var i = f.owner(g),
            j = i.dom(),
            k = a.fromDom(j.createDocumentFragment()),
            l = b.fromHtml(h, j);
          d.append(k, l), e.empty(g), c.append(g, k);
        },
        i = function(b) {
          var d = a.fromTag('div'),
            e = a.fromDom(b.dom().cloneNode(!0));
          return c.append(d, e), g(d);
        };
      return { get: g, set: h, getOuter: i };
    }),
    g('51', ['4q', '4r', '6e', '6f', '2w', 'p', '6g', 'k', '28', '6h', '1g'], function(
      a,
      b,
      c,
      d,
      ...
      var l = 'data-textbox-image',
        ...
        s = function(b, c, d) {
          var f = r(b.data()),
            g = n(f);
          return d.cleanDocument(g, c).fold(
            function() {
    ...
    g('7x', ['p', '1d', '83'], function(a, b, c) {
      var d = function(b, d, e, f) {
          var g = f.name,
            h = void 0 !== f.condition ? f.condition : a.constant(!0),
        ...
        e = function(c, d) {
          var e = b.name(c),
            f = d.name,
            g = void 0 !== d.condition ? d.condition : a.constant(!0);
    ...
    g('8h', ['g', '1c', 'j', '5d', '37'], function(a, b, c, d, e) {
      var f = function(b) {
        ...
        j = function(b, c, d) {
          var e = b.dom().getAttribute('style'),
            g = f(e),
            h = {};
          return (
            a.each(c, function(a) {
        ...
        l = function(a, d, e) {
          ...
          var f = b.size(d),
            g = b.size(e);
          if (0 === f && 0 === g) c.remove(a, 'style');
          else if (0 === f) c.set(a, 'style', k(e));
          else {
    ...
    g('7i', ['g', '1l', '7x', '7y', 'p', 'j', '27', '3q', '1y', '2a'], function(
      a,
      b,
      c,
      d,
      ...
      var k = function(b, d, e) {
        ...
        l = function(l, m) {
          var n = b.merge({ styles: [], attributes: [], classes: [], tags: [] }, m),
            o = j.descendants(l, '*');
          a.each(o, function(b) {
            k(d.style, n.styles, b),
              k(d.attribute, n.attributes, b),
              a.each(n.classes, function(c) {
    ...
    g('6m', ['g', '7i', '7j', 'k', '6h', '1y', '3f'], function(a, b, c, d, e, f, g) {
      var h = function(a) {
        ...
        n = function(a, b) {
          return (
            a.indexOf('<o:p>') >= 0 ||
            (b.browser.isSpartan() && a.indexOf('v:shapes="') >= 0) ||
            (b.browser.isSpartan() && a.indexOf('mso-') >= 0) ||
            a.indexOf('mso-list') >= 0 ||
            a.indexOf('p.MsoNormal, li.MsoNormal, div.MsoNormal') >= 0 ||
            a.indexOf('MsoListParagraphCxSpFirst') >= 0 ||
            a.indexOf('<w:WordDocument>') >= 0
          );
      ...
      var g = function(a, b) {
        ...
        j = function(b) {
          var d = f.fromDom(b.getNode()),
            e = a.scan(d, ['mso-list'], c.constant(!1));
          return e['mso-list'];
        };
    ...
    g('8t', ['g', '8u', '96', '8l', 'p', '2c', 'j', 'k'], function(a, b, c, d, e, f, g, h) {
      var i = function(a, b) {
        ...
        j = function(a) {
          var b = parseInt(g.get(a, 'data-list-level'), 10),
            c = g.get(a, 'data-list-emblems'),
            d = JSON.parse(c);
          return (
            g.remove(a, 'data-list-level'),
            g.remove(a, 'data-list-emblems'),
            { level: e.constant(b), emblems: e.constant(d) }
          );
        },
        k = f.immutable('level', 'token', 'type'),
        l = function(c) {
          return !a.contains(['P'], c.tag()) || /^MsoHeading/.test(b.getAttribute(c, 'class'));
        },
        m = function(a, b, d, e) {
          var f = d.getCurrentListType(),
            g = d.getCurrentLevel(),
            h = g == e.level() ? f : null;
    ...
    g('8i', ['8t', '86', '8u', '8v', '8w', '8l'], function(a, b, c, d, e, f) {
      var g = function(a) {
          var c = function(b, c, d) {
            ...
            g = function(a, c) {
              return (
                c.type() === b.END_ELEMENT_TYPE &&
                a.originalToken.get() &&
                c.tag() === a.originalToken.get().tag()
              );
            };
        ...
        h = function(g) {
          ...
          return e(
            'Outside.List.Item',
            [
              d(a.predicate, a.action(g), 'Data List ****'),
              d(
                i,
                function(a, b, c) {
                  a.emit(c);
      ...
      var c = function(c) {
        ...
        d = function(c, d) {
          var e = c.items().slice(0),
            f = void 0 !== d && 'P' !== d ? b.some(d) : b.none();
          f.fold(
            function() {
              e.push('P');
            },
    ...
    g('9l', ['7y', '86', '96', '97', '9j', '9v', 'p'], function(a, b, c, d, e, f, g) {
      var h = function(a, c, e) {
          var f = c.start && c.start > 1 ? { start: c.start } : {},
            h = a.level() + 1,
            i = c,
            j = a.types().concat([c]),
            k = [g.curry(b.createStartElement, c.tag, f, e)],
            l = d.state(h, i, j, a.items());
          return d.result(l, k);
        },
        i = function(a) {
          var c = a.types().slice(0),
            e = [g.curry(b.createEndElement, c.pop().tag)],
            f = a.level() - 1,
            h = c[c.length - 1],
            i = d.state(f, h, c, a.items());
          return d.result(i, e);
        },
        j = function(a, b) {
          var c = i(a),
            e = h(c.state(), b, b.type ? { 'list-style-type': b.type } : {});
          return d.result(e.state(), c.result().concat(e.result()));
        },
        k = function(h, i, k) {
          var l = {},
            m = f.from(i),
            n = h.type() && !c.eqListType(h.type(), k) ? j(h, k) : d.result(h, []),
            o = [g.curry(b.createStartElement, 'LI', l, m)],
            p = e.start(n.state(), i && i.tag()),
            q = p
              .value()
              .map(function(b) {
    ...
    g('98', ['g', '86', '97', '9j', '9k', '9l', 'p', 'n'], function(a, b, c, d, e, f, g, h) {
      var i = function(b) {
        ...
        l = function(a, b, d) {
          var e = a.level() > 0 ? f.closeItem(a) : c.result(a, []),
            g = f.openItem(e.state(), d, b);
          return i([e, g]);
        },
        m = function(a, b, c, d) {
        ...
        o = function(a, e, f, i) {
          var j = f > 1 ? d.finish(a) : c.value(a, h.none()),
            k = j
              .value()
              .map(function(a) {
              ...
              .getOr([]),
            l = (f - j.state().level(), m(j.state(), e, f, i));
    ...
    h('8o', parseInt),
    g('8y', ['g', '1l', '64', '8o'], function(a, b, c, d) {
      var e = [
          { regex: /^\(?[dc][\.\)]$/, type: { tag: 'OL', type: 'lower-alpha' } },
          { regex: /^\(?[DC][\.\)]$/, type: { tag: 'OL', type: 'upper-alpha' } },
          {
        ...
        j = function(c, d) {
          var j = g[c] ? [g[c]] : [],
            k = d && f[c] ? [f[c]] : d ? [{ tag: 'UL', variant: c }] : [],
    ...
    g(
      '8m',
      ['g', '8y', '8h', 'p', 'n', '5d', '6h', '1d', '6r', '7o', '3f', '62', '64', '8o'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        var o = 18,
          ...
          v = function(b) {
            return (
              h.isElement(b) &&
              f.getRaw(b, 'font-family').exists(function(b) {
    ...
    h('8n', JSON),
    g('82', ['g', '8m', 'n', 'j', '7r', '1d', '1y', '3f', '8n', '8o'], function(
      a,
      b,
      c,
      d,
      ...
      var k = function(a, b, c) {
        ...
        q = function(a) {
          return 'p' !== f.name(a)
            ? c.none()
            : b.extractLevel(a).bind(function(c) {
        ...
        r = function(a) {
          return 'p' !== f.name(a)
            ? c.none()
            : b.extractMsoIgnore(a).bind(function(c) {
    ...
    g('84', ['g', 'j', '6h', '1d', '6n'], function(a, b, c, d, e) {
      var f = function(a) {
        ...
        k = function(a) {
          return (
            void 0 === a.dom().attributes ||
            null === a.dom().attributes ||
            (0 === a.dom().attributes.length ||
              (1 === a.dom().attributes.length && 'style' === a.dom().attributes[0].name))
          );
        },
        l = function(a) {
    ...
    g('85', ['g', '1c', 'n', 'j', '5d', 'k', '6h', '1x', '29', '1d', '1y', '8p', '3f'], function(
      a,
      b,
      c,
      d,
      ...
      var n = function(b, c) {
        ...
        p = function(a) {
          return m.prevSibling(a).bind(function(a) {
            return j.isText(a) && 0 === l.get(a).trim().length
              ? p(a)
              : 'li' === j.name(a)
              ? c.some(a)
              : c.none();
        ...
        r = function(a) {
          var c = n('span', a),
            f = { face: 'font-family', size: 'font-size', color: 'color' },
            g = {
              'font-size': {
                1: '8pt',
                2: '10pt',
          ...
          b.each(f, function(a, b) {
            if (d.has(c, b)) {
              var f = d.get(c, b),
                h = void 0 !== g[a] && void 0 !== g[a][f] ? g[a][f] : f;
    ...
    g('7h', ['7w', '6m', '7k', '84', '85', 'p', '27', '5d', '3f', '1d', '83'], function(
      a,
      b,
      c,
      d,
      ...
      var l = b.unwrapper({ tags: [{ name: k.pattern(/^([OVWXP]|U[0-9]+|ST[0-9]+):/i) }] }),
        m = [b.pipeline([c.filter])],
        n = b.removal({
          attributes: [
            { name: k.pattern(/^v:/) },
            { name: k.exact('href'), value: k.contains('#_toc') },
            { name: k.exact('href'), value: k.contains('#_mso') },
            { name: k.pattern(/^xmlns(:|$)/) },
            { name: k.exact('type'), condition: d.isList },
          ],
        }),
        o = b.removal({ attributes: [{ name: k.exact('id') }, { name: k.exact('name') }] }),
        p = b.removal({
          tags: [
            { name: k.exact('script') },
            { name: k.exact('meta') },
            { name: k.exact('link') },
            { name: k.exact('style'), condition: d.isEmpty },
          ],
          attributes: [
            { name: k.starts('on') },
            { name: k.exact('"') },
            { name: k.exact('lang') },
            { name: k.exact('language') },
          ],
        ...
        s = b.removal({
          styles: [
            { name: k.not(k.pattern(/width|height|list-style-type/)), condition: q },
        ...
        v = b.removal({ classes: [{ name: k.pattern(/mso/i) }] }),
        w = b.unwrapper({
          tags: [
            { name: k.exact('img'), condition: d.isLocal },
            { name: k.exact('a'), condition: d.hasNoAttributes },
          ],
        }),
        ...
        A = b.unwrapper({
          tags: [{ name: k.pattern(a.specialInline()), condition: f.not(d.hasContent) }],
        }),
        B = b.unwrapper({ tags: [{ name: k.exact('p'), condition: r('li') }] }),
        C = b.transformer({ tags: [{ name: k.exact('p'), mutate: e.addBrTag }] }),
        D = function(a) {
          var b = e.changeTag('span', a);
          g.add(b, 'ephox-limbo-transform'), h.set(b, 'text-decoration', 'underline');
        },
        E = b.transformer({ tags: [{ name: k.pattern(/ol|ul/), mutate: e.properlyNest }] }),
        F = b.transformer({
          tags: [
            { name: k.exact('b'), mutate: f.curry(e.changeTag, 'strong') },
            { name: k.exact('i'), mutate: f.curry(e.changeTag, 'em') },
            { name: k.exact('u'), mutate: D },
            { name: k.exact('s'), mutate: f.curry(e.changeTag, 'strike') },
            { name: k.exact('font'), mutate: e.fontToSpan, debug: !0 },
          ],
        }),
        G = b.removal({ classes: [{ name: k.exact('ephox-limbo-transform') }] }),
        H = b.removal({
          attributes: [{ name: k.exact('href'), value: k.starts('file:///'), debug: !0 }],
        });
      return {
        unwrapWordTags: l,
    ...
    g('6k', ['g', '5a', '7h', '6m', '7k', '7l', 'p', 'k'], function(a, b, c, d, e, f, g, h) {
      var i = function(a) {
        ...
        j = function(a) {
          return f(
            function(b, c, d) {
              var e = a(h.fromDom(c.getNode())).fold(
                function() {
                  return c;
                },
                function(a) {
        ...
        k = function(a, e, f) {
          var g = f.browser.isFirefox() || f.browser.isSpartan() ? b.local : b.vshape,
            h = i(f) ? c.none : d.pipeline([j(g)]),
            k = g === b.local ? c.none : c.removeLocalImages,
            l = a ? h : c.none;
        ...
        m = function(a, b, d) {
          var e = [c.mergeStyles, c.mergeClasses],
            f = [c.cleanStyles, c.cleanClasses];
          return b ? e : f;
        },
        n = function(a, b, c) {
        ...
        q = function(b, d, e) {
          ...
          return a.flatten([
            ...
            f.local,
            m(b, d, e),
            [c.removeLocalLinks, c.removeVacantLinks],
            [c.removeEmptyStyle],
            [c.removeEmptyClass],
            [c.pruneInlineTags],
            [c.addPlaceholders],
      ...
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
        return function() {
          ...
          return {
            ...
            query: c.constant({
              comparePosition: u,
              prevSibling: q.prevSibling,
              nextSibling: q.nextSibling,
            }),
            property: c.constant({
              children: q.children,
              name: j.name,
    ...
    g('90', ['2c'], function(a) {
      var b = a.immutable('element', 'offset'),
        ...
        d = a.immutable('element', 'start', 'finish'),
        e = a.immutable('begin', 'end'),
    ...
    g('9o', ['g', 'p'], function(a, b) {
      var c = function(c, d, e, f) {
        var g = a.findIndex(c, b.curry(f, d)),
          h = g > -1 ? g : 0,
          i = a.findIndex(c, b.curry(f, e)),
          j = i > -1 ? i + 1 : c.length;
        return c.slice(h, j);
      };
      return { boundAt: c };
    ...
    g('9r', ['1m'], function(a) {
      ...
      return {
        include: b.include,
        excludeWith: b.excludeWith,
        excludeWithout: b.excludeWithout,
        cata: c,
      };
    }),
      ...
      var e = function(b, d, f) {
          ...
          if (b.property().isElement(d)) {
            var g = b.property().children(d),
              h = b.property().isBoundary(d) ? [c.boundary(d, b)] : [],
              i =
                void 0 !== f && f(d)
                  ? []
                  : a.bind(g, function(a) {
    ...
    g('9g', ['g', '1l', 'p'], function(a, b, c) {
      var d = function(d, e) {
        return a.map(d, function(a) {
          return b.merge(a, {
            start: c.constant(a.start() + e),
            finish: c.constant(a.finish() + e),
          });
        });
      };
      return { translate: d };
    ...
    g('9s', ['g', 'n'], function(a, b) {
      var c = function(c, d, e) {
        var f = [d].concat(c.up().all(d)),
          g = [e].concat(c.up().all(e)),
          h = a.find(f, function(b) {
        ...
        h = function(h, i, j, k, l) {
          return h.eq(i, k)
            ...
            : d.common(h, i, k).fold(
                ...
                function(d) {
                  var m = [d].concat(c.all(h, d, b.constant(!1))),
                    n = f(h, m, i),
                    o = f(h, m, k),
                    p = n > -1 && o > -1 ? g(m, n, j, o, l) : [],
                    q = e(h);
    ...
    g('9c', ['g', 'n', '90', '94', '9u'], function(a, b, c, d, e) {
      var f = function(f, g, h) {
        var i = f.property().getText(g),
          j = a.filter(e.splits(i, h), function(a) {
            return a.length > 0;
          });
        ...
        var k = d.generate(
            ...
            function(a, d) {
              var e = f.create().text(a),
                g = c.range(e, d, d + a.length);
              return b.some(g);
            },
            j[0].length
          ),
          l = a.map(k, function(a) {
            return a.element();
          });
    ...
    g('93', ['g', 'p', '9c', '94'], function(a, b, c, d) {
      var e = function(e, f, g) {
        var h = a.bind(g, function(a) {
          ...
          j = d.splits(f, h, i),
          k = function(c) {
            var f = d.sublist(j, c.start(), c.finish()),
      ...
      var b = function(b, c) {
        for (var d = c.term(), e = [], f = d.exec(b); f; ) {
          var g = f.index + c.prefix(f),
            h = f[0].length - c.prefix(f) - c.suffix(f);
          e.push({ start: a.constant(g), finish: a.constant(g + h) }),
            (d.lastIndex = g + h),
            (f = d.exec(b));
        }
        return e;
    ...
    g('8r', ['g', 'n', '8z', '90', '91', '92', '93', '7n', '94', '95'], function(
      a,
      b,
      c,
      d,
      ...
      var k = function(a, c) {
        ...
        l = function(b, c, d, h) {
          var i = e.group(b, c, h),
            l = a.bind(i, function(c) {
              var e = f.justText(c),
                h = a.map(e, b.property().getText).join(''),
                i = j.findmany(h, d),
                l = k(b, e);
    ...
    g(
      '6l',
      ['g', 'n', '7m', '7n', '2c', 'j', '5d', 'k', '1x', '29', '1d', '1z', '7o', '3f'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        var o = /((([A-Za-z]{3,9}:(?:\/\/)?)(?:[\-;:&=\.\+\$,\w]+@)?[A-Za-z0-9\.\-]+|(?:www\.|[\-;:&=\+\$,\w\.]+@)[A-Za-z0-9\.\-]+)(:[0-9]+)?((?:\/[\+~%\/\.\w\-_]*)?\??(?:[\-_.~*+=!&;:'%@?^${}()\w,]*)#?(?:[\-_.~*+=!&;:'%@?^${}()\w,\/]*))?)/g,
          ...
          r = 9,
          s = function(a) {
            var b = e.immutable('word', 'pattern'),
              f = d.unsafetoken(p),
              g = b('__INTERNAL__', f);
            return c.run(a, [g]);
          },
    ...
    g('6i', ['4q', '4r', '4y', '2w', '2t', '55', '2f', '28', '1f'], function(
      a,
      b,
      c,
      d,
      ...
      var j = e.detect(),
        k = function(a, b, c, d) {
          try {
            var e = f.go(a, j, b, c, d),
              k = void 0 !== e && null !== e && e.length > 0,
              l = k ? h.fromHtml(e) : [];
            return g.value(l);
          } catch (m) {
    ...
    g('54', ['4q', '6j', '4r', '31', '2w', 'n', '23', '28', '11'], function(
      a,
      b,
      c,
      d,
      ...
      var j = function(a) {
        ...
        k = function(a) {
          return d.isValidData(a)
            ? g.findMap(a.types, function(b) {
    ...
    g(
      '34',
      ['4q', '4r', '4z', '51', '52', '53', '54', '2w', '2t', '55', 'p', 'k', '29', '3f', '1f'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
        var p = i.detect(),
          q = function(a, b, c) {
            return g.handle(a);
    ...
    g('57', ['6m', 'j', '6h', '6n'], function(a, b, c, d) {
      var e = function(a, c) {
        ...
        g = function(a, b) {
          var c = a.browser,
            d = c.isIE() && c.version.major >= 11 ? e : f;
          return d(b, a);
        };
      return { isWord: g };
    }),
        ...
        return function(m, n) {
          ...
          return a.sync(function(l) {
            ...
            n.events.after.bind(function(d) {
              ...
              var m = e.isWord(h, j),
                n = g.children(j),
                q = k.findClipboardTags(n, m).isSome();
              a.call(l, {
                response: p,
    ...
    g('7p', ['8d', '7q', '8e', 'n', '2f'], function(a, b, c, d, e) {
      var f = function(a, b) {
        ...
        g = function(a) {
          return a.indexOf('\\pngblip') >= 0
            ? e.value('image/png')
            : a.indexOf('\\jpegblip') >= 0
            ? e.value('image/jpeg')
            : e.error('errors.imageimport.unsupported');
        },
        h = function(a) {
        ...
        i = function(a, b) {
          var c = a.match(b);
          return c && c[1] && c[1].length % 2 === 0
            ? e.value(c[1])
            : e.error('errors.imageimport.invalid');
        },
        j = function(a) {
      ...
      var i = function(b, d, f) {
        ...
        m = function(i, j, m, n) {
          var o = l(j),
            p = [],
            q = !1,
            r = c.bind(i, function(b, c) {
              var d = f.get(b, 'data-image-type'),
                i = f.get(b, 'data-image-id');
            ...
            b.convert(
              ...
              function(a, b, c) {
                var h = f.children(d),
                  ...
                  l = b.concat(g);
                c
                  ? i.trigger.incomplete(h, j, l, 'errors.imageimport.failed')
                  : i.trigger.insert(h, j, l),
                  k();
              },
              h
            );
      ...
      return function(h, i) {
        ...
        var l = function(a, d, e) {
          ...
          if (i.allowLocalImages === !0 && i.enableFlashImport === !0) {
            var p = h(i);
            p.events.response.bind(l),
              p.events.cancel.bind(n),
              p.events.failed.bind(o),
              p.events.error.bind(o),
              p.open();
    ...
    g(
      '36',
      ['4q', '4r', '58', '59', '2w', 'g', '5a', 'p', 'n', 'z', 'k', '29', '1y', '3f'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        return function(o, p) {
          var q = c(o, p),
            r = d(p),
                  ...
                  o = function(a, c, o) {
                    ...
                    l.append(u, a),
                      b.rtf().fold(
                        ...
                        function(a) {
                          if (p.allowLocalImages === !0) r.processRtf(u, c, o, a, h.noop);
                          else {
                            var b = g.find(u),
                              d = n.children(u);
                            b.length > 0
                              ? (f.each(b, m.remove),
                                t(e.incomplete(d, c, o, 'errors.local.images.disallowed')))
                              : t(e.paste(d, c, o));
                          }
                        }
                      );
    ...
    g(
      '1p',
      ['2z', '30', '31', '32', '33', '34', '35', '36', '2t', 'p', 'n', '2c', '37', '11'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        var o = l.immutable('data', 'rtf'),
          p = i.detect(),
          q = '^image/',
          r = 'file',
          s = [q, r],
          ...
          v = function(a) {
            return (
              m.contains(a, '<html') &&
              (m.contains(a, 'xmlns:o="urn:schemas-microsoft-com:office:office"') ||
                m.contains(a, 'xmlns:x="urn:schemas-microsoft-com:office:excel"'))
            );
          },
          w = function(a) {
            var b = a.clipboardData;
            return c.isValidData(b)
              ? c.getFlavor(b.types, t).bind(function(c) {
          ...
          A = function(a) {
            return p.browser.isIE()
              ? k.some(n.clipboardData)
              : c.isValidData(a.clipboardData)
              ? k.some(a.clipboardData)
              : k.none();
          },
          B = function(a) {
            if (p.browser.isSpartan()) return k.none();
            var b = a.clipboardData,
              d = c.isValidData(b) ? b.types : [];
            return 1 === d.length && 'text/plain' === d[0] ? k.some(b) : k.none();
          },
          C = function(a) {
            var b = a.clipboardData;
            return c.isValidData(b)
              ? c.getFlavor(b.types, u).bind(function(a) {
          ...
          D = function(a, b, c, d) {
            return {
              ...
              getAvailable: b,
              steps: j.constant(c),
              capture: j.constant(d),
            };
          },
          E = function(c, d, h, i) {
            var k = j.curry(z, i);
            return D(
              'Within Textbox.io (tables) pasting',
              k,
              [
                a.normal(g(d, c, h, i, b.ignore)),
                a.normal(e.fixed(!0, !0)),
                a.normal(f.internal(h, i)),
              ],
              !1
            );
          },
          F = function(c, i, j, k, l, m, n) {
            return D(
              'Outside of Textbox.io pasting (could be internal but another browser)',
              x,
              [
                a.normal(g(k, j, l, n, b.background)),
                a.normal(e.fromConfigIfExternal(c, i)),
                a.normal(f.external(l, n)),
                a.blocking(h(m, i)),
                a.normal(d(i)),
              ],
              !1
          ...
          G = function(b, c, d, g) {
            return D(
              ...
              w,
              [
                a.normal(f.setBundle({ isWord: !0 })),
                a.normal(e.fromConfig(c, d)),
                a.normal(f.gwt(b)),
                a.blocking(h(g, d)),
              ],
              !0
          ...
          H = function(b) {
            return D(
              'Image pasting',
              y,
              [a.normal(b.allowLocalImages === !1 ? f.noImages(j.noop) : f.images())],
              !0
            );
          },
          I = function() {
            return D(
              ...
              B,
              [a.normal(f.plain), a.normal(f.autolink)],
              !0
            );
          },
          J = function() {
    ...
    g('5b', ['5c', '2t', 'j', '27', 'k', '6h', '29'], function(a, b, c, d, e, f, g) {
      var h = function() {
        ...
        j = function(b) {
          ...
          var f = h(),
            j = e.fromHtml('<p>' + b('cement.dialog.flash.trigger-paste') + '</p>'),
            k = e.fromHtml(
              '<div><span class="ephox-polish-help-kbd">' +
                f +
                '</span> + <span class="ephox-polish-help-kbd">V</span></div>'
            );
    ...
    h('5e', navigator),
    g('38', ['5b', '5c', '2t', 'p', '27', '5d', 'k', '1x', '29', '5e'], function(
      a,
      b,
      c,
      d,
      ...
      return function(a, c, f) {
        var h = g.fromTag('div'),
          i = 'flashbin-wrapper-' + (k.os.isOSX() ? 'cmd' : 'ctrl');
        e.add(h, b.resolve(i));
        var j = m() ? o : n,
          l = j(h, a, c, f.translations);
        return { element: d.constant(h), reset: l.reset };
      };
    }),
    h('5k', clearInterval),
    h('5m', setInterval),
    g('5f', ['n', '21', '22', 'z', '5k', '5m'], function(a, b, c, d, e, f) {
      var g = function() {
        var g = d(a.none()),
          h = c.create({ crashed: b([]), timeout: b([]) }),
          i = function(b, c, d, i) {
            var j = c,
              k = f(function() {
                d()
                  ? e(k)
                  : j <= 0
                  ? (h.trigger.timeout(), e(k))
                  : i() && (e(k), h.trigger.crashed()),
                  j--;
              }, b);
            g.set(a.some(k));
          },
      ...
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y) {
        ...
        return function(g) {
          ...
          var C = function(a) {
            ...
            K = function() {
              var a = g.replace(/^https?:\/\//, '//'),
                b = 'onLoad=' + E,
                c =
                  '    <param name="allowscriptaccess" value="always">    <param name="wmode" value="opaque">    <param name="FlashVars" value="' +
                  b +
                  '">';
              ...
              return p.fromHtml(
                '<object type="application/x-shockwave-flash" data="' + a + '">' + c + '</object>'
              );
            },
            L = K(),
            M = function() {
          ...
          var O = function() {
            ...
            Q = null,
            R = function() {
              n.add(s, c.resolve('flash-activate')),
                o.remove(L, 'height'),
                o.remove(L, 'width'),
                h.trigger.hide();
            },
    ...
    g('5o', ['5p', '2c', 'k'], function(a, b, c) {
      var d = b.immutable('start', 'soffset', 'finish', 'foffset'),
        ...
        g = function(b) {
          var d = c.fromDom(b.startContainer),
    ...
    g('6u', ['5o', '6v', 'k', '3f'], function(a, b, c, d) {
      var e = function(a) {
          return b.after(
            c.fromDom(a.anchorNode),
            a.anchorOffset,
            c.fromDom(a.focusNode),
            a.focusOffset
          );
        },
        f = function(b, d) {
          var f = c.fromDom(d.startContainer),
            g = c.fromDom(d.endContainer);
          return e(b)
            ? a.read(g, d.endOffset, f, d.startOffset)
            : a.read(f, d.startOffset, g, d.endOffset);
        },
        g = function(a) {
          return e(a);
        },
        h = function(a, b, c, e) {
          return function(f) {
            if (f.extend) f.collapse(a.dom(), b), f.extend(c.dom(), e);
            else {
              var g = d
                .owner(a)
                .dom()
    ...
    g('5s', ['5o', '6u', 'n', '6v', 'k'], function(a, b, c, d, e) {
      var f = function(b, d) {
          ...
          if (f.collapsed === !0) {
            ...
            return g.collapsed === !0
              ? c.none()
              : c.some(
                  a.general(
                    e.fromDom(g.endContainer),
                    g.endOffset,
        ...
        j = function(a, b, c, e, f) {
          var g = d.after(b, c, e, f),
            h = a.document.createRange();
          return (
            g
              ? (h.setStart(e.dom(), f), h.setEnd(b.dom(), c))
              : (h.setStart(b.dom(), c), h.setEnd(e.dom(), f)),
            h
          );
        },
        k = function(a, b) {
    ...
    g('5r', ['g', '5s', 'k', '1d', '2a', '2h'], function(a, b, c, d, e, f) {
      var g = function(a, b, c) {
          return (
            a.selectNodeContents(c.dom()),
            a.compareBoundaryPoints(b.END_TO_START, b) < 1 &&
              a.compareBoundaryPoints(b.START_TO_END, b) > -1
          );
        },
        h = function(b, c, d, h) {
          var i = b.document.createRange(),
            j = f.is(c, h) ? [c] : [],
            k = j.concat(e.descendants(c, h));
          return a.filter(k, function(a) {
            return g(i, d, a);
          });
        },
        i = function(a, e, f) {
          var g = b.forceRange(a, e),
            i = c.fromDom(g.commonAncestorContainer);
    ...
    g('6w', ['g', '5o', '5p', '1d'], function(a, b, c, d) {
      var e = function(b, e) {
        ...
        f = function(a) {
          var d = a.start().fold(c.before, e, c.after),
            f = a.finish().fold(c.before, e, c.after);
          return b.write(d, f);
        };
    ...
    g('5t', ['5o', '6u', '5s', '6w', 'n', 'k', '6x'], function(a, b, c, d, e, f, g) {
      var h = function(a) {
        ...
        j = function(a, b) {
          ...
          return (
            e.setStart(c.startContainer, c.startOffset), e.setEnd(d.endContainer, d.endOffset), e
          );
        },
        k = function(c, d) {
          var e = f.fromDom(d.startContainer),
            g = f.fromDom(d.endContainer);
        ...
        r = function(a, b, d, e) {
          return function(g, h) {
            var i = c.toExactNative(g, a, b, d, e),
              j = i.cloneContents();
            return f.fromDom(j);
          };
        },
        s = function(a, b, d, f) {
          return function(g, h) {
            var i = c.toExactNative(g, a, b, d, f),
              j = i.getClientRects(),
    ...
    g('3a', ['5o', '5p', '5q', '5r', '5s', '5t', '3n', 'k'], function(a, b, c, d, e, f, g, h) {
      var i = function(a) {
        ...
        v = function(b, c) {
          ...
          return a.general(
            h.fromDom(d.startContainer),
            d.startOffset,
            h.fromDom(d.endContainer),
            d.endOffset
          );
        },
        w = function(a) {
    ...
    g(
      '5v',
      ['1s', '2c', '6y', '6z', 'j', '27', '3q', '5d', '70', 'k', '6h', '1x', '1y', '20', '3f'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
        var p = d.resolve('bin'),
          q = p + a.generate(''),
          r = i.onDirection('-100000px', '100000px');
        return function(a) {
          var d = j.fromTag('div');
          e.setAll(d, { contenteditable: 'true', 'aria-hidden': 'true' }),
            h.setAll(d, {
              position: 'fixed',
              top: '0px',
              width: '100px',
    ...
    g('3d', ['p', '2x', '21', '22', '2y', '5v', '3f'], function(a, b, c, d, e, f, g) {
      return function(h, i) {
        var j = f(h),
          ...
          n = d.create({ before: c([]), after: c(['elements', 'html', 'container']) }),
          o = a.noop;
    ...
    g('1r', ['2t', '3a', '21', '22', '3b', '3c', '3d', '1d'], function(a, b, c, d, e, f, g, h) {
      ...
      return function(a) {
        var b = d.create({ after: c(['container']) }),
          e = k(a),
          f = g(e, a);
    ...
    g('5y', ['w', 'k', '1g'], function(a, b, c) {
      var d = function(d) {
        if ('complete' === c.readyState || 'interactive' === c.readyState) d();
        else
          var e = a.bind(b.fromDom(c), 'DOMContentLoaded', function() {
            d(), e.unbind();
          });
      };
      return { execute: d };
    }),
    g('3e', ['2t', '5h', 'p', '5w', 'n', '5x', '5i', '5d', 'w', 'k', '1x', '5y', '1y'], function(
      a,
      b,
      c,
      d,
      ...
      var n = b.install('ephox.keurig.init'),
        o = e.none(),
        p = a.detect(),
        q = p.browser,
              ...
              var d = i.bind(c, 'load', function() {
                ...
                f.write(
                  ...
                  '<script type="text/javascript" src="' +
                    i +
                    '"></script><script type="text/javascript">function gwtInited () {parent.window.' +
                    h +
                    '(com.ephox.keurig.WordCleaner.cleanDocument);};</script>'
                ),
                  d.unbind();
              });
              l.execute(function() {
    ...
    g('l', ['1o', '1p', '1q', '1r', 'g', '1s', '1t', 'p', 'n'], function(
      a,
      b,
      c,
      d,
      ...
      return function(j, k, l, m) {
        var n = g(m.baseUrl),
          ...
          s = e.flatten([
            void 0 !== m.intraFlag ? [b.internal(l, p, j, r)] : [],
            [b.onlyText()],
            [b.gwt(n, k, m, o)],
            [b.image(m)],
          ]),
      ...
      var e = function(a) {
        ...
        f = function(d) {
          a.each(a.map(d.getElementsByTagName('*'), b.fromDom), function(a) {
            c.has(a, 'data-mce-style') &&
              !c.has(a, 'style') &&
              c.set(a, 'style', c.get(a, 'data-mce-style'));
          });
        };
          ...
          var j,
            ...
            u = function() {
              ...
              var b = e.fromDom(j.getEl()),
                c = h
                  .descendant(b, '.' + d.get(n, 'class'))
                  .getOrDie('We must find this element or we cannot continue');
    ...
    g('u', ['g', 'n', '23', '24'], function(a, b, c, d) {
      var e = function(a) {
        ...
        k = function(a, c) {
          return (
            a.insertContent(c, { merge: a.settings.paste_merge_formats !== !1, paste: !0 }),
            b.some(!0)
          );
        },
        l = function(a, b, d) {
    ...
    g('8', [], function() {
      var a = function(a, b) {
        ...
        g = function(a) {
          var b = a.settings,
            c = a.plugins.powerpaste;
          b.paste_preprocess &&
            a.on('PastePreProcess', function(d) {
              b.paste_preprocess.call(a, c, d);
            }),
            b.paste_postprocess &&
              a.on('PastePostProcess', function(d) {
    ...
    g(
      '6',
      ['l', 'm', 'g', 'n', 'o', 'p', 'd', 'q', 'r', 's', 't', 'u', '8', 'v', 'w', 'k', 'x', '2'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
        return function(s, t, u, v, w) {
          var x, y, z, A, B;
          (B = (v ? v.jsUrl : u) + '/js'),
            (y = (v ? v.swfUrl : u) + '/flash/textboxpaste.swf'),
            (z = (v ? v.imgUrl : u) + '/img/spinner_96.gif'),
            (A = (v ? v.cssUrl : u) + '/css/editorcss.css');
          var C = function(a) {
          ...
          s.on('init', function(d) {
            ...
            var l = {
              ...
              C = a(u, r.createDialog, f.noop, l),
              D = b();
            c.each([C, D], v),
              o.bind(u, 'paste', function(a) {
                x || (x = s.selection.getBookmark());
                var b = t.isText() ? D : C;
                b.paste(a.raw()),
                  t.reset(),
                  q(function() {
                    s.windowManager.windows[0] &&
                      s.windowManager.windows[0].getEl() &&
                      s.windowManager.windows[0].getEl().focus();
                  }, 1);
              });
          }),
    ...
    g('7', ['y', 'z'], function(a, b) {
      ...
      return function(d) {
        var e = b(d.settings.paste_as_text),
          f = b(!1);
        d.on('keydown', function(a) {
          c(a) &&
            (f.set(!0),
            tinymce.Env.ie && tinymce.Env.ie < 10 && (a.preventDefault(), d.fire('paste', {})));
        });
        var g = a(function() {
            var a = d.translate(
          ...
          h = function() {
            ...
            a.active(b),
              e.set(b),
              d.fire('PastePlainTextToggle', { state: b }),
              b === !0 && 0 != d.settings.paste_plaintext_inform && g(),
              d.focus();
          },
          i = function() {
            f.set(!1);
    ...
    g('1', ['3', '4', '5', '6', '7', '8', '9', 'a', '2'], function(a, b, c, d, e, f, g, h, i) {
      return function(j) {
        return g.isLessThan(i, '4.0.0')
          ? (h.error('The "powerpaste" plugin requires at least 4.0.0 version of TinyMCE.'),
            function() {})
          : function(g, h) {
              var k = e(g),
                l = function() {
              ...
              g.settings.powerpaste_block_drop &&
                g.on('init', function(a) {
    ...
    g('0', ['1', '2'], function(a, b) {
      return function(c) {
        b.PluginManager.requireLangPack(
          'powerpaste',
