    ...
    <div class="ns-container">
      <div class="ns-container-right">
        <div class="action-module">
          <demo-block>
            <template slot="title">表单 table 用法</template>
        ...
        <biz-table-v3 ref="biz-table-form" :loadState="loadState" :data="tableData"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      validate() {
        this.$refs['biz-table-form'].checkAll();
      },
      reset() {
        this.$refs['biz-table-form'].resetCheck();
      },
      requestNew() {
