<!--UI 组件库 - Select-tree - 页面测试-->
<template>
  <div>
    <!--基础属性用法-->
    <selectTreeDemoBasic></selectTreeDemoBasic>
    <!--空值显示设定-->
    <selectTreeDemoEmpty></selectTreeDemoEmpty>
    <!--model/value 相关显示用法-->
...
<script>
  import selectTreeDemoBasic from './template/basic';
  ...
  export default {
    ...
    methods: {},
    created() {
      this.$store.dispatch('generateSelectTree');
    },
    mounted() {
